...
const SkillBox = ({ skill: { title, description, icons } }: Props) => {
  ...
  return (
    <div className="group relative flex flex-col items-center justify-center p-4 rounded-xl border border-white/10 bg-zinc-900/40 backdrop-blur-md transition-all duration-300 hover:border-accent/50 hover:bg-zinc-900/60 w-full sm:w-[calc(33.33%-12px)] min-h-[130px] overflow-hidden m-1.5">
      {/* Background Glow */}
      ...
      <div className="relative flex flex-col items-center text-center space-y-3">
        ...
        <div className="space-y-1">
          <span className="block text-[11px] font-bold text-zinc-100 group-hover:text-accent transition-colors uppercase tracking-tight">
            {title}
          </span>
